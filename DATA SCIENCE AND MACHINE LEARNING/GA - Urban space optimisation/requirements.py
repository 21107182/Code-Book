...
def check_requirements():
    ...
    if not sys.version_info[:2] == (2, 7):
        ...
        if sys.version_info[0] > (2):
            print ("Warning: The tool is testet for Python 2.7 and 3.3. You started the tool with Python version from %s." %python_version)
            # test Python 3
            #close_window()      
    # path to the site-packages folder
    #print ("sys.path: %s" %sys.path)
    python_libfolder = "F:\\Anaconda\\Lib\\site-packages"
